			...
			<main className="mx-auto max-w-3xl px-4 py-10">
				...
				<div className="mb-8">
					...
					<p className="mt-2 text-gray-500">
						Discover posts from everyone in the community.
					</p>
					...
					posts.length === 0 && (
						...
						<div className="rounded-3xl bg-white p-10 text-center shadow-sm">
							...
							<p className="mx-auto mt-2 max-w-md text-gray-500">
								There aren't any posts available right now.
								Be the first person to share something.
							</p>

							<Link
								to="/posts/create"
								className="mt-6 inline-block rounded-full bg-black px-6 py-3 font-semibold text-white transition hover:bg-gray-800"
							>
